...
import interfaces.consultasReportes_equipos;
import static interfaces.loggin.icono;
import interfaces.menuEquipos;
import static interfaces.registroMantenimientos_tabla.id_equipo;
 ...
 * @author Josue Lopez
 */
public class consultasMantenimientos_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form consultasMantenimientos_tabla
     */
    ...
    public consultasMantenimientos_tabla() {
        initComponents();
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(consultasReportes_equipos.consulta_inicial);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 101, 970, 340));
        ...
        jPanel1.add(boton_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, -1, -1));
        ...
        jPanel1.add(boton_buscar_ubicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 60, -1, -1));
        ...
        jPanel1.add(barra_busqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 120, -1));
        ...
        jPanel1.add(boton_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, -1, -1));
        ...
        jPanel1.add(barra_ubicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 60, 210, -1));

        jButton1.setBackground(new java.awt.Color(255, 204, 51));
        jButton1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/reportes_30.png"))); // NOI18N
        jButton1.setText("Reporte de Mantenimientos");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 40, 250, 48));
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        try {
            Connection cn = Conection_bd.conexion_bd();
            PreparedStatement pst = cn.prepareStatement(consultasReportes_equipos.consulta_barra+barra_busqueda.getText().toUpperCase().trim() + "%'");
            ResultSet rs = pst.executeQuery();
            tabla = new JTable(modelo_tabla);
            //para no poder mover las columnas
            tabla.getTableHeader().setReorderingAllowed(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        reporteMantenimientos mbm = new reporteMantenimientos();
        mbm.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultasMantenimientos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultasMantenimientos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    consultasMantenimientos_datos inf = new consultasMantenimientos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
