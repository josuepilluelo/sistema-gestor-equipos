...
import static interfaces.consultasMantenimientos_datos.columnas_tabla_inicial;
 ...
 * @author Josue Lopez
 */
public class reporteMantenimientos extends javax.swing.JFrame {

    private String fecha = "", fecha_2 = "", tipo = "", fecha_pdf_1 = "", fecha_pdf_2 = "";
    public static int tipo_consulta_pdf = 0, columnas_tabla_inicial = 5, columnas_tabla_inicial_pdf = 10;
    private String titulo = "", consulta_pdf = "";                              //12 campos

    public static String consulta_pdf_todos = "";

    public static String consulta_pdf_fecha = "";
    private String consulta_mantemienientos = "select "
            + "ROW_NUMBER() OVER( ORDER BY e.id_matenimiento) as NP, "
            + "e.servicios, "
    ...
    /**
     * Creates new form reporteMantenimientos
     */
    ...
    public reporteMantenimientos() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(consulta_mantemienientos);
    ...
    private void initComponents() {
        ...
        setTitle("Reporte mantenimientos");
        ...
        jPanel1.add(boton_consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 40, 191, 43));
        ...
        jPanel1.add(boton_reporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, -1, 46));

        etiqueta_resporte.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        etiqueta_resporte.setText("Tipo de reporte activo:");
        jPanel1.add(etiqueta_resporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 420, 618, -1));
        ...
        jPanel1.add(botn_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(474, 41, 150, 43));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 960, 280));
    ...
    private void boton_consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_consultarActionPerformed
        ...
        if (barra_fecha_1.getDate() == null) {
            ...
            //                tipo = "MUEBLE";
            System.out.println("Tipo de reporte activo: Mantenimientos de " + fecha_pdf_1 + " a " + fecha_pdf_2);
            etiqueta_resporte.setText("Tipo de reporte activo: Mantenimientos del ■■ " + fecha_pdf_1 + " ■■  al  ■■ " + fecha_pdf_2 + " ■■");
            ...
            try {
                ...
                PreparedStatement pst1 = cn1.prepareStatement("select "
                        ...
                        + "DATE_ADD(e.fecha_mantenimiento, interval 1 day) "
                        + "from mantenimiento_equipo e "
                        + "where fecha_mantenimiento BETWEEN '" + fecha + "' AND '" + fecha_2 + "' "
                        + "ORDER BY id_matenimiento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reporteMantenimientos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reporteMantenimientos().setVisible(true);
            }
        });
    }
