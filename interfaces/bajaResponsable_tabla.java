 ...
 * @author Josue Lopez
 */
public class bajaResponsable_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form bajaResponsable
     */
    public bajaResponsable_tabla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 700, 320));
        ...
        jPanel1.add(boton_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 70, -1, -1));
        ...
        boton_regresar.setPreferredSize(new java.awt.Dimension(130, 39));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajaResponsable_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bajaResponsable_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    bajaResponsable_datos inf = new bajaResponsable_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
