 ...
 * @author Josue Lopez
 */
public class asignacionequipos_tabla1 extends javax.swing.JFrame {
    public static int id_equipo = 0;
    private int tipo_consulta_pdf = 0, columnas_tabla_inicial = 12;
    private String titulo = "", consulta_extra;                              //12 campos
    private String consulta_inicial = "select "
            ...
            + "where NOT e.estado_equipo = 'BAJA' and not e.id_responsable <> 1";
    ...
    /**
     * Creates new form asignacionequipos_tabla1
     */
    public asignacionequipos_tabla1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 950, 370));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(asignacionequipos_tabla1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new asignacionequipos_tabla1().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    asignacionEquipos_datos inf = new asignacionEquipos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
