...
import static interfaces.modificarInformacion_equipos_tabla.id_equipo;
 ...
 * @author Josue Lopez
 */
public class registroMantenimientos_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form resgistroMantenimientos_tabla
     */
    public registroMantenimientos_tabla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 960, 340));
        ...
        jPanel1.add(boton_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 70, -1, -1));
        ...
        jPanel1.add(barra_busqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 200, -1));
        ...
        jPanel1.add(barra_ubicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 70, 210, -1));
        ...
        jPanel1.add(boton_buscar_ubicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 70, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registroMantenimientos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registroMantenimientos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    registroMantenimientos_registro inf = new registroMantenimientos_registro();
                    inf.setVisible(true);
                }
                dispose();
            }
