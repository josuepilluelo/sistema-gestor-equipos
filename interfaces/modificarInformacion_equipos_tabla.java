 ...
 * @author Josue Lopez
 */
public class modificarInformacion_equipos_tabla extends javax.swing.JFrame {
    
    public static int id_equipo = 0;
    private int tipo_consulta_pdf = 0, columnas_tabla_inicial = 13;
    ...
    /**
     * Creates new form modificarInformacion_equipos_
     */
    public modificarInformacion_equipos_tabla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(boton_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, -1, -1));
        ...
        jPanel1.add(barra_busqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 220, -1));
        ...
        jPanel1.add(boton_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 970, 340));
        ...
        jPanel1.add(barra_ubicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 70, 210, -1));
        ...
        jPanel1.add(boton_buscar_ubicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 70, -1, -1));
    ...
    private void boton_buscar_ubicacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscar_ubicacionActionPerformed
        ...
        try {
            ...
            //modelo_tabla.
            while (rs.next()) {
                Object[] fila = new Object[consultasReportes_equipos.columnas_tabla_inicial];//por las columnas que tengo
                for (int i = 0; i < consultasReportes_equipos.columnas_tabla_inicial; i++) {
                    fila[i] = rs.getObject(i + 1);
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    modificarInformacion_equipos_datos inf = new modificarInformacion_equipos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarInformacion_equipos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarInformacion_equipos_tabla().setVisible(true);
            }
        });
    }
