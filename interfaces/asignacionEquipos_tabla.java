 ...
 * @author Josue Lopez
 */
public class asignacionEquipos_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form asignacionEquipos_tabla
     */
    public asignacionEquipos_tabla() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(asignacionEquipos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new asignacionEquipos_tabla().setVisible(true);
            }
        });
    }
