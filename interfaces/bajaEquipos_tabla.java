...
import static interfaces.consultasReportes_equipos.*;
 ...
 * @author Josue Lopez
 */
public class bajaEquipos_tabla extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 950, 340));
        ...
        jPanel1.add(boton_reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, -1, -1));
        ...
        jPanel1.add(barra_busqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 200, -1));
        ...
        jPanel1.add(boton_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, -1, -1));
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        try {
            Connection cn = Conection_bd.conexion_bd();
            PreparedStatement pst = cn.prepareStatement(consulta_barra + barra_busqueda.getText().toUpperCase().trim() + "%' and NOT e.estado_equipo = 'BAJA'");
            ResultSet rs = pst.executeQuery();
            tabla = new JTable(modelo_tabla);
            //para no poder mover las columnas
            tabla.getTableHeader().setReorderingAllowed(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajaEquipos_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bajaEquipos_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    bajaEquipos_datos inf = new bajaEquipos_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
