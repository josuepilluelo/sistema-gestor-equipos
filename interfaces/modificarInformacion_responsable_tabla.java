...
import static interfaces.bajaResponsable_tabla.id_responsable;
 ...
 * @author Josue Lopez
 */
public class modificarInformacion_responsable_tabla extends javax.swing.JFrame {
    ...
    /**
     * Creates new form modificarInformacion_responsable_tabla
     */
    public modificarInformacion_responsable_tabla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(754, 500));
        jPanel1.setPreferredSize(new java.awt.Dimension(754, 500));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 700, 340));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarInformacion_responsable_tabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarInformacion_responsable_tabla().setVisible(true);
            }
        });
    }
        ...
        tabla.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (num_fila > -1) {
                    ...
                    id_responsable = (int) modelo_tabla.getValueAt(num_fila, num_columna);
                    System.out.println(modelo_tabla.getValueAt(num_fila, num_columna));
                    //nombre = (int) modelo_tabla.getValueAt(num_fila, num_columna);
                    modificarInformacion_responsable_datos inf = new modificarInformacion_responsable_datos();
                    inf.setVisible(true);
                }
                dispose();
            }
